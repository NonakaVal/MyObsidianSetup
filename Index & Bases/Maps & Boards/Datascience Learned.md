...
- [ ] ##### 🔧 Operações com Dados
	...
	- [[flow-pandas-basic-data-manipulation 1|Manipulação Básica]]
	- [[py-pandas-groupby-method|GroupBy]]
...
%% kanban:settings
```
{"kanban-plugin":"board","list-collapse":[false,true,true,false,false],"lane-width":410}
```
%%