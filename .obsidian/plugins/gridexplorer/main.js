...
var ExplorerView = class extends import_obsidian11.ItemView {
  ...
  shouldShowFolder(folder) {
    ...
    const childFolders = folder.children.filter((f) => f instanceof import_obsidian11.TFolder).filter((f) => !isFolderIgnored(f, settings.ignoredFolders, settings.ignoredFolderPatterns, showIgnoredItems));
  ...
  hasVisibleTopLevelFolders(showIgnoredItems) {
    ...
    const settings = this.plugin.settings;
    const topLevelFolders = root.children.filter((f) => f instanceof import_obsidian11.TFolder).filter((f) => !isFolderIgnored(f, settings.ignoredFolders, settings.ignoredFolderPatterns, showIgnoredItems));
  ...
  renderTopLevelFolders(foldersChildren, showIgnoredItems) {
    const root = this.app.vault.getRoot();
    const settings = this.plugin.settings;
    let topLevelFolders = root.children.filter((f) => f instanceof import_obsidian11.TFolder).filter((f) => !isFolderIgnored(f, settings.ignoredFolders, settings.ignoredFolderPatterns, showIgnoredItems));
    if (this.isFiltering()) {
  ...
  setupToggleIcon(folder, toggle, expanded) {
    ...
    const activeGrid = this.app.workspace.getActiveViewOfType(GridView);
    const showIgnoredItems = (_a = activeGrid == null ? void 0 : activeGrid.showIgnoredItems) != null ? _a : false;
    const hasVisibleChildren = folder.children.filter((f) => f instanceof import_obsidian11.TFolder).some((f) => !isFolderIgnored(f, settings.ignoredFolders, settings.ignoredFolderPatterns, showIgnoredItems));
  ...
  hasVisibleChildren(folder) {
    ...
    const activeGrid = this.app.workspace.getActiveViewOfType(GridView);
    const showIgnoredItems = (_a = activeGrid == null ? void 0 : activeGrid.showIgnoredItems) != null ? _a : false;
    return folder.children.filter((f) => f instanceof import_obsidian11.TFolder).some((f) => !isFolderIgnored(f, settings.ignoredFolders, settings.ignoredFolderPatterns, showIgnoredItems));
  }
  // 在網格視圖中開啟資料夾
  ...
  renderChildFolders(folder, childrenContainer, depth) {
    ...
    const activeGrid = this.app.workspace.getActiveViewOfType(GridView);
    const showIgnoredItems = (_a = activeGrid == null ? void 0 : activeGrid.showIgnoredItems) != null ? _a : false;
    let childFolders = folder.children.filter((f) => f instanceof import_obsidian11.TFolder).filter((f) => !isFolderIgnored(f, settings.ignoredFolders, settings.ignoredFolderPatterns, showIgnoredItems));
    if (this.isFiltering()) {
...
var NoteSettingsModal = class extends import_obsidian19.Modal {
  ...
  async onOpen() {
    ...
    if (this.files[0].extension === "md") {
      new import_obsidian19.Setting(contentEl).setName(t("display_hidden")).setDesc(t("display_hidden_desc")).addToggle((toggle) => {
        hiddenToggle = toggle;
...
var GridView = class extends import_obsidian20.ItemView {
  ...
  async setState(state) {
    ...
    if (state == null ? void 0 : state.state) {
      ...
      this.showIgnoredItems = (_f = state.state.showIgnoredItems) != null ? _f : false;
...
var GridExplorerSettingTab = class extends import_obsidian21.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian21.Setting(sectionEl).addButton((button) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(`\u{1F4D1} ${t("show_bookmarks_mode")}`).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showBookmarksMode).onChange(async (value) => {
        this.plugin.settings.showBookmarksMode = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian21.Setting(sectionEl).setName(`\u{1F50D} ${t("show_search_mode")}`).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showSearchMode).onChange(async (value) => {
        this.plugin.settings.showSearchMode = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian21.Setting(sectionEl).setName(`\u{1F517} ${t("show_backlinks_mode")}`).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showBacklinksMode).onChange(async (value) => {
        this.plugin.settings.showBacklinksMode = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian21.Setting(sectionEl).setName(`\u{1F517} ${t("show_outgoinglinks_mode")}`).addToggle((toggle) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(`\u{1F4D4} ${t("show_all_files_mode")}`).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showAllFilesMode).onChange(async (value) => {
        this.plugin.settings.showAllFilesMode = value;
        await this.plugin.saveSettings();
      });
    });
    const recentFilesSetting = new import_obsidian21.Setting(sectionEl).setName(`\u{1F4C5} ${t("show_recent_files_mode")}`);
    ...
    const randomNoteSetting = new import_obsidian21.Setting(sectionEl).setName(`\u{1F3B2} ${t("show_random_note_mode")}`);
    ...
    new import_obsidian21.Setting(sectionEl).setName(`\u2611\uFE0F ${t("show_tasks_mode")}`).addToggle((toggle) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("reuse_existing_leaf")).setDesc(t("reuse_existing_leaf_desc")).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.reuseExistingLeaf).onChange(async (value) => {
        this.plugin.settings.reuseExistingLeaf = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian21.Setting(sectionEl).setName(t("default_open_location")).setDesc(t("default_open_location_desc")).addDropdown((dropdown) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("default_sort_type")).setDesc(t("default_sort_type_desc")).addDropdown((dropdown) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("date_divider_mode")).setDesc(t("date_divider_mode_desc")).addDropdown((dropdown) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("folder_display_style")).setDesc(t("folder_display_style_desc")).addDropdown((dropdown) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("show_media_files")).setDesc(t("show_media_files_desc")).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showMediaFiles).onChange(async (value) => {
        this.plugin.settings.showMediaFiles = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian21.Setting(sectionEl).setName(t("show_video_thumbnails")).setDesc(t("show_video_thumbnails_desc")).addToggle((toggle) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("show_note_in_grid")).setDesc(t("show_note_in_grid_desc")).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showNoteInGrid).onChange(async (value) => {
        this.plugin.settings.showNoteInGrid = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian21.Setting(sectionEl).setName(t("open_note_layout")).setDesc(t("open_note_layout_desc")).addDropdown((dropdown) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("note_title_field")).setDesc(t("note_title_field_desc")).addText((text) => text.setPlaceholder("title").setValue(this.plugin.settings.noteTitleField).onChange(async (value) => {
      this.plugin.settings.noteTitleField = value;
      await this.plugin.saveSettings(false);
    }));
    new import_obsidian21.Setting(sectionEl).setName(t("note_summary_field")).setDesc(t("note_summary_field_desc")).addText((text) => text.setPlaceholder("summary").setValue(this.plugin.settings.noteSummaryField).onChange(async (value) => {
      this.plugin.settings.noteSummaryField = value;
      await this.plugin.saveSettings(false);
    }));
    new import_obsidian21.Setting(sectionEl).setName(t("modified_date_field")).setDesc(t("modified_date_field_desc")).addText((text) => text.setPlaceholder("modified_date").setValue(this.plugin.settings.modifiedDateField).onChange(async (value) => {
      this.plugin.settings.modifiedDateField = value;
      await this.plugin.saveSettings(false);
    }));
    new import_obsidian21.Setting(sectionEl).setName(t("created_date_field")).setDesc(t("created_date_field_desc")).addText((text) => text.setPlaceholder("created_date").setValue(this.plugin.settings.createdDateField).onChange(async (value) => {
      this.plugin.settings.createdDateField = value;
      await this.plugin.saveSettings(false);
    }));
    new import_obsidian21.Setting(sectionEl).setName(t("custom_document_extensions")).setDesc(t("custom_document_extensions_desc")).addText((text) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("custom_folder_icon")).setDesc(t("custom_folder_icon_desc")).addText((text) => {
      text.setValue(this.plugin.settings.customFolderIcon).onChange(async (value) => {
        this.plugin.settings.customFolderIcon = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian21.Setting(sectionEl).setName(t("enable_file_watcher")).setDesc(t("enable_file_watcher_desc")).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.enableFileWatcher).onChange(async (value) => {
        this.plugin.settings.enableFileWatcher = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian21.Setting(sectionEl).setName(t("intercept_all_tag_clicks")).setDesc(t("intercept_all_tag_clicks_desc")).addToggle((toggle) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("intercept_breadcrumb_clicks")).setDesc(t("intercept_breadcrumb_clicks_desc")).addToggle((toggle) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("card_layout")).setDesc(t("card_layout_desc")).addDropdown((drop) => {
      drop.addOption("horizontal", t("horizontal_card"));
      drop.addOption("vertical", t("vertical_card"));
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("show_note_tags")).setDesc(t("show_note_tags_desc")).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showNoteTags).onChange(async (value) => {
        this.plugin.settings.showNoteTags = value;
        await this.plugin.saveSettings();
      });
    });
    const gridItemWidthSetting = new import_obsidian21.Setting(sectionEl).setName(`${t("horizontal_card")} ${t("grid_item_width")}`).setDesc(`${t("grid_item_width_desc")} (now: ${this.plugin.settings.gridItemWidth}px)`).addSlider((slider) => {
    ...
    const gridItemHeightSetting = new import_obsidian21.Setting(sectionEl).setName(`${t("horizontal_card")} ${t("grid_item_height")}`).setDesc(`${t("grid_item_height_desc")} (now: ${this.plugin.settings.gridItemHeight === 0 ? "auto" : this.plugin.settings.gridItemHeight})`).addSlider((slider) => {
    ...
    const imageAreaWidthSetting = new import_obsidian21.Setting(sectionEl).setName(`${t("horizontal_card")} ${t("image_area_width")}`).setDesc(`${t("image_area_width_desc")} (now: ${this.plugin.settings.imageAreaWidth}px)`).addSlider((slider) => {
    ...
    const imageAreaHeightSetting = new import_obsidian21.Setting(sectionEl).setName(`${t("horizontal_card")} ${t("image_area_height")}`).setDesc(`${t("image_area_height_desc")} (now: ${this.plugin.settings.imageAreaHeight}px)`).addSlider((slider) => {
    ...
    const vGridItemWidthSetting = new import_obsidian21.Setting(sectionEl).setName(`${t("vertical_card")} ${t("grid_item_width")}`).setDesc(`${t("grid_item_width_desc")} (now: ${this.plugin.settings.verticalGridItemWidth}px)`).addSlider((slider) => {
    ...
    const vGridItemHeightSetting = new import_obsidian21.Setting(sectionEl).setName(`${t("vertical_card")} ${t("grid_item_height")}`).setDesc(`${t("grid_item_height_desc")} (now: ${this.plugin.settings.verticalGridItemHeight}px)`).addSlider((slider) => {
    ...
    const vImageAreaHeightSetting = new import_obsidian21.Setting(sectionEl).setName(`${t("vertical_card")} ${t("image_area_height")}`).setDesc(`${t("image_area_height_desc")} (now: ${this.plugin.settings.verticalImageAreaHeight}px)`).addSlider((slider) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(`${t("vertical_card")} ${t("image_position")}`).setDesc(t("image_position_desc")).addDropdown((dropdown) => {
    ...
    const titleFontSizeSetting = new import_obsidian21.Setting(sectionEl).setName(t("title_font_size")).setDesc(`${t("title_font_size_desc")} (now: ${this.plugin.settings.titleFontSize.toFixed(2)})`).addSlider((slider) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("multi_line_title")).setDesc(t("multi_line_title_desc")).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.multiLineTitle).onChange(async (value) => {
        this.plugin.settings.multiLineTitle = value;
        await this.plugin.saveSettings();
      });
    });
    const summaryLengthSetting = new import_obsidian21.Setting(sectionEl).setName(t("summary_length")).setDesc(`${t("summary_length_desc")} (now: ${this.plugin.settings.summaryLength})`).addSlider((slider) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("show_code_block_in_summary")).setDesc(t("show_code_block_in_summary_desc")).addToggle((toggle) => toggle.setValue(this.plugin.settings.showCodeBlocksInSummary).onChange(async (value) => {
      this.plugin.settings.showCodeBlocksInSummary = value;
      await this.plugin.saveSettings();
    }));
    sectionEl = this.createSection(t("default_search_option"));
    new import_obsidian21.Setting(sectionEl).setName(t("search_current_location_only")).addToggle((toggle) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("search_files_name_only")).addToggle((toggle) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("search_media_files")).addToggle((toggle) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("foldernote_display_settings")).setDesc(t("foldernote_display_settings_desc")).addDropdown((dropdown) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("quick_access_folder_name")).setDesc(t("quick_access_folder_desc")).addText((text) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("quick_access_mode_name")).setDesc(t("quick_access_mode_desc")).addDropdown((dropdown) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("use_quick_access_as_new_tab_view")).setDesc(t("use_quick_access_as_new_tab_view_desc")).addDropdown((dropdown) => {
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("ignored_folders")).setDesc(t("ignored_folders_desc")).setHeading();
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("ignored_folder_patterns")).setDesc(t("ignored_folder_patterns_desc")).setHeading();
    ...
    new import_obsidian21.Setting(sectionEl).setName(t("config_management")).setDesc(t("config_management_desc")).addButton((button) => button.setButtonText(t("reset_to_default")).setWarning().onClick(async () => {
