...
# Principais Propriedades das Notas 
>  `tag`, `Hubs` e `connections`

### TAG
- ! Classificar TIPO ou OBJETIVO da nota,  também usado para gestão de TAREFAS
```
`learning` - notas de estudo
`resources`- ferramentas ou listas de materiais externos 
...
### CONNECTIONS
- ! Notas relacionadas em contexto ou objetivo
![Imgur](https://i.imgur.com/D4R0mV4.png)
...
- [Code files](obsidian://show-plugin?id=code-files)
- [Charts](obsidian://show-plugin?id=obsidian-charts)
